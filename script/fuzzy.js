...
function klik_proses() {
  //alert('ok');
  //var tanggungan = 3;
  var tanggungan = parseFloat($("#inTG").val());
  console.log("tanggungan : " + tanggungan);

  tanggungan = mf_TG(tanggungan);
  ...
  //aturan/rules
  rendah.push(fmin(tanggungan.buruk, gaji.kecil));
  rendah.push(fmin(tanggungan.buruk, gaji.sedang));
  rendah.push(fmin(tanggungan.buruk, gaji.besar));
  rendah.push(fmin(tanggungan.buruk, gaji.sangatbesar));

  tinggi.push(fmin(tanggungan.cukup, gaji.kecil));
  rendah.push(fmin(tanggungan.cukup, gaji.sedang));
  rendah.push(fmin(tanggungan.cukup, gaji.besar));
  rendah.push(fmin(tanggungan.cukup, gaji.sangatbesar));

  tinggi.push(fmin(tanggungan.bagus, gaji.kecil));
  tinggi.push(fmin(tanggungan.bagus, gaji.sedang));
  tinggi.push(fmin(tanggungan.bagus, gaji.besar));
  rendah.push(fmin(tanggungan.bagus, gaji.sangatbesar));
